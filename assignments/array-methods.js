...
// Problem 1
// Everyone who donated less than $100 to the cause is being shamed. Get a list of runners that donated less than $100 and push them to a list of their own.
const shamefulRunners = runners.filter((runner) => runner.donation < 100);
// shamefulRunners.forEach((runner) => console.log(`${runner.first_name} ${runner.last_name} only donated $${runner.donation}. SHAME.`))
